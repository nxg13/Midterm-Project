var questionArray = [
    ...
    (insert image of the graph of q2)"The graph above supports which of the following statements?"
    ...
    question6.png "Which of the following conclusions about income distribution during the Reagan administration is supported by the table above?",
    "Registered voters directly elect which of the following?" question7.png,
    ...
    question24.png "The data displayed in the table above best supports which of the following statements?",
    ...
    "The advantages of incumbency in congressional elections include which of the following?" question34.png,
    ...
    "Public monies are used to help finance which of the following campaigns?" question40.png,
...
var answerArray = [
    ...
    ["Debate by a determined minority in either chamber cannot be halted.", "The rules in each chamber are determined by the majority whip.", "The rules are specified in Article I of the Constitution.", 
"The rules can be changed by the President during a national emergency.", "The House operates more by formal rules, while the Senate operates more on informal understandings.",],
